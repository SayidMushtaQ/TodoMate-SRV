...
export const updateTodo = asyncHanlder(async (req, res) => {
  ...
  if (
    ...
    todo.content.description === description &&
    todo.isComplete === isComplete
  ) {
    return res
      .status(200)
      .json(
        new ApiResponse(200, todo, {
  ...
  const updatedTodo = await Todo.findByIdAndUpdate({ _id: todoID }, update, {
    new: true
  });
  ...
  res
    .status(200)
    .json(
      new ApiResponse(200, updatedTodo, {
        message: "Todo item updated successfully",
